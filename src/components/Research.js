...
const Research = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      content:
        "Detailed content about Northern peatlands and their relationship with climate change...",
    },
    {
      title:
        "CH4 and GHG emissions as microbiome responses to manipulations: Landfill case",
      content:
        "Information about microbiome responses in landfill environments...",
    },
    {
      title:
      ...
      <div className="research">
        ...
        <section className="topics">
          ...
          <p>
            ...
            interdisciplinary and transdisciplinary projects, spanning
            molecular, microbial, ecological, spatial, and applied sciences.
          </p>
